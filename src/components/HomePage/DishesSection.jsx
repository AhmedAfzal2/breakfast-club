...
const dummyDishes = [
    ...
    { id: 1, name: "Sweet Strawberrry Milkshake", description: "Creamy, sweet strawberry milkshake with whipped cream and cherry add-ons", image: "/assets/images/menu-items/drinks/milkshakes/strawberry_milkshake.png" },
    { id: 2, name: "Waffles", description: "Hot waffles with authentic maple syrup add-on", image: "/assets/images/menu-items/breakfast/hot-breakfast/waffle.png" },
    { id: 3, name: "Hot Chocolate" , description: "Rich hot chocolate topped with whipped cream and marshmallows", image: "/assets/images/menu-items/drinks/hot_chocolate/hot_chocolate.png" },
    { id: 4, name: "Cinammon Rolls", description: "Freshly baked cinnamon rolls with icing drizzle", image: "/assets/images/menu-items/dessert/pastries/cinnamon_rolls.png"},
