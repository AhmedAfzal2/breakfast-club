...
function SelectTablePopup({
  ...
  }, [gameContainerRef.current]); // run once on mount
  ...
  return (
    <div
      className={`mobile-select-table-popup ${isClosing ? "slide-down" : ""}`}
    >
      ...
      <div className="mobile-popup-content">
        <label className="heading section-label mobile-popup-heading">
          select table
        </label>

        <div
          className={`mobile-table-game-container ${
              ...
              {isHelpPopupOpen && (
                <div className="mobile-help-popup">
                  <div className="mobile-help-popup-content">
                    <h4 className="mobile-help-popup-title">
                      Game Instructions
                    </h4>
        ...
        {isHelpPopupOpen && (
          <div
            className="mobile-help-popup-overlay"
            onClick={() => setIsHelpPopupOpen(false)}
          >
            <div
              className="mobile-help-popup-container"
            ...
            {selectedTables.length > 0 ? (
              <>
                <div className="mobile-table-numbers">
                  <span className="mobile-reservation-label">
                    Selected Tables:{" "}
                  </span>
